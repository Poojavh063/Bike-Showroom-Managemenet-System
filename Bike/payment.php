...
<br><br><b>Enter the available details of the payment:</b><br><br>
<div class="container"> 
<form  method="POST" action=# >
  ...
  <div class="form-input">
	...
	<div class="form-input">
		<b>DATE:</b>
		<input type="DATE" name="dt"  placeholder="DATE" style="background-color: #cccccc" size="40">
	</div>
    <div class="form-input">
		<b>PAYMENT TYPE:</b>
		<input type="VARCHAR" name="pt" placeholder="PAYMENT TYPE" style="background-color: #cccccc"  size="40">
	</div>
	<div class="form-input">
		<b>AMOUNT:</b>
		<input type="DECIMAL" name="amt" placeholder="AMOUNT" style="background-color: #cccccc"  size="40">
  	</div>
